var app = {
    ...
    onDeviceReady: function() {
        ...
        ons.setDefaultDeviceBackButtonListener(function() {
            if (navigator.notification.confirm("Вы уверены что хотите выйти?", 
                function(index) {
    ...
    module.controller('FeedPluginMasterController', function($scope, $http, FeedPluginData) {
        ...
        success(function(data, status, headers, config) {
            ...
            if (!data.responseData) {
                $scope.msg = "Устойство не может получить данные.";
            } else {
        ...
        error(function(data, status, headers, config) {
        $scope.msg = 'Произошла ошибка:' + status; 
        });
    ...
    module.controller('ContactController', function($scope) {
        ...
        $scope.submitForm = function() {
            ...
            window.plugin.email.open({
                to:      ['hichnick@gmail.com'],
                cc:      ['info@tac-shop.ru'],
                bcc:     ['manager@tac-shop.ru'],
